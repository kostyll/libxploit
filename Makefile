...
$(PROGNAME): payloads/x86-exec.c payloads/null.c payloads/cmd-bind-awk.c payloads/cmd-generic.c payloads/cmd-bind-nc.c payloads/cmd-bind-perl.c payloads/cmd-reverse-perl.c libxploit.c xploit.h module.h exploits.c exploits.h payloads.c payloads.h exploits/dummy-mod.c exploits/vmware-mount.c exploits/setuid-nmap.c exploits/fdisc-webmin.c exploits/exec-awstats.c http-client.c utils.c pick.c
